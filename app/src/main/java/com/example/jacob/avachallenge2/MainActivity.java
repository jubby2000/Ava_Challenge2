package com.example.jacob.avachallenge2;
...
//                if (fab.getDrawable().getConstantState().equals(getResources().getDrawable(R.drawable.ic_stop_white_24dp).getConstantState())){
//                    fab.setImageResource(R.drawable.ic_mic_white_24dp);
//                    Snackbar.make(view, "Recording complete!", Snackbar.LENGTH_LONG)
//                            .show();
//                } else {
//                    fab.setImageResource(R.drawable.ic_stop_white_24dp);
//                    Snackbar.make(view, "Now recording!", Snackbar.LENGTH_LONG)
//                            .show();
//                }
//
//
...
//    }
    ...
    private void requestPermissions() {
        int micPermissionCheck = ContextCompat.checkSelfPermission(this,
